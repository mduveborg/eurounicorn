...
namespace EurounicornAPI.Authentication
{
    ...
    {
        private const short KeyLength = sizeof(ulong) * 2;
        ...
        /// Input string <paramref name="str">s</paramref> contains invalid Base32-k characters.
        /// </exception>
    ...
    public class Cryptography
    {
        ...
        public static string GenerateToken(int byteCount = 32)
        {
            ...
            new Random(result).NextBytes(bytes);
